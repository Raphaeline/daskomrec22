    ...
    <div class="container pb-5">
      <div class="pt-5 d-flex justify-content-center">
        <div class="checker-box">
          ...
          <div class="text-center pt-3 pb-3 rekrutmen-warning">
            ...
            <div style="background-color: #dc3545;border-radius: 0.7rem;margin-top:0.6rem;">
              <span class="mention" style="color: rgb(226, 226, 226)">Pastikan kalian yakin dengan jadwal yang kalian pilih</span>
            </div>
          </div>
        </div>
      </div>
      <div class="p-3">
        <div class="card-body">
          ...
          <table style="background-color: #FFB936;" class="table table-bordered table-hover table-striped text-center align-middle">
            <thead>
              <tr>
