        ...
        <div class="dlor-navright ">
          <ul class="navbar-nav dlor-navright position-fixed end-0 top-0 me-lg-4 mt-lg-4" id="dlor-toggler">
            <li class="nav-item-login my-1 mx-3">
              <a style="font-weight: 400;" class="nav-link text-center" href="/logoutLogistik" tabindex="-1" aria-disabled="true">LOGOUT</a>
            </li>
          </ul>
        </div>
    </nav>
    ...
    <div class="container pb-5">
      <div class="pt-5 d-flex justify-content-center">
        <div class="checker-box">
          ...
          <div class="d-flex justify-content-center pt-3">
            <button class="button-submit" type="submit" data-bs-toggle="modal" data-bs-target="#editpass">
              <span style="font-size: 1.5rem">Ganti Password</span>
            </button>
          </div>
          @error('password')
          <div class="text-center pt-1">
            <span class="text-center" style="color: red;font-weight:600;font-size:1.5rem">Untuk ganti Password, Minimal 8 Karakter</span>
          </div>
          @enderror
        </div>
      </div>
      <div class="p-3">
        <div class="card-body">
          ...
          @if($countshift!=0)
          <div class="text-center table-caas">
